                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif ($row->status == 'SETTLEMENT')
                                    <span class="badge bg-info">Setlement</span>
                                @else
                            ...
                            <td>
                                @if (Auth::user()->role == 'admin')
                                    <a href="{{ route('admin.my-transaction.showDataBySlugAndId', [$row->id, $row->slug]) }}"
                                        class="btn btn-info"><i class="bi bi-eye"></i>
                                    </a>
                                @else
                                    <a href="{{ route('user.my-transaction.showDataBySlugAndId', [$row->id, $row->slug]) }}"
                                        class="btn btn-info"><i class="bi bi-eye"></i>
                                    </a>
                                @endif
