...
<body>
    ...
    <section class="flex items-center hero">
        <div
            ...
            <div>
                <a href="{{ route('login') }}"
                    class="bg-pink-400 text-black hover:bg-black hover:text-pink-400 rounded-full px-8 py-3 mt-4 inline-block flex-none transition duration-200">Explore</a>
            </div>
    ...
    <section class="container mx-auto">
        <div class="flex justify-center flex-wrap">
            <div class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0">
                <img src="{{ asset('frontend/images/content/logo-adobe.svg') }}" class="mx-auto" />
            </div>
            <div class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0">
                <img src="{{ asset('frontend/images/content/logo-ikea.svg') }}" class="mx-auto" />
            </div>
            <div class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0">
                <img src="{{ asset('frontend/images/content/logo-hermanmiller.svg') }}" class="mx-auto" />
            </div>
            <div class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0">
                <img src="{{ asset('frontend/images/content/logo-miele.svg') }}" class="mx-auto" />
            </div>
        </div>
    </section>
    <!-- END: CLIENTS -->
