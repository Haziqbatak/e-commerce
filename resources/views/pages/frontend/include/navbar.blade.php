            ...
            <div class="w-auto">
                <ul class="items-center flex">
                    @if (Auth::check())
                        ...
                        <li class="mx-3 py-6 md:py-0">
                            <a href="{{ route('admin.dashboard') }}" class="text-black md:text-white hover:underline">{{ $item->name }}</a>
                        </li>
                        ...
                        <li class="mx-3 py-6 md:py-0">
                            <a href="{{ route('user.dashboard') }}" class="text-black md:text-white hover:underline">{{ $item->name }}</a>
                        </li>
